...
prekey1=substitution(sv,p,k,m,1)
prekey2=substitution(sv,p,k,m,2)
prekey3=substitution(sv,p,k,m,3)
prekey4=substitution(sv,p,k,m,4)
print("Предварительный ключ 1 участника конференц-связи (список prekey):", prekey1)
print("Предварительный ключ 2 участника конференц-связи (список prekey):", prekey2)
print("Предварительный ключ 3 участника конференц-связи (список prekey):", prekey3)
print("Предварительный ключ 4 участника конференц-связи (список prekey):", prekey4)
